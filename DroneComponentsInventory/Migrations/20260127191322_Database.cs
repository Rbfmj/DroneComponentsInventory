        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    weight_g = table.Column<double>(type: "REAL", nullable: true),
                    length_mm = table.Column<double>(type: "REAL", nullable: true),
                    width_mm = table.Column<double>(type: "REAL", nullable: true),
                    height_mm = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mount_pattern_mm = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lens_focal_mm = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    manufacturer = table.Column<string>(type: "TEXT", nullable: false),
                    model = table.Column<string>(type: "TEXT", nullable: false),
                    stator_size_mm = table.Column<double>(type: "REAL", nullable: true),
                    ...
                    recommended_prop_inch = table.Column<string>(type: "TEXT", nullable: true),
                    max_thrust_grams = table.Column<double>(type: "REAL", nullable: true),
                    price = table.Column<double>(type: "REAL", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pitch_inch = table.Column<double>(type: "REAL", nullable: true),
                    blade_count = table.Column<int>(type: "INTEGER", nullable: true),
                    material = table.Column<string>(type: "TEXT", nullable: true),
                    shaft_diameter_mm = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    radiation_pattern = table.Column<string>(type: "TEXT", nullable: true),
                    operating_frequency_mhz = table.Column<string>(type: "TEXT", nullable: true),
                    weight_grams = table.Column<int>(type: "INTEGER", nullable: true),
                    price = table.Column<double>(type: "REAL", nullable: true)
                },
                constraints: table =>
