(function () {
    ...
    /* ---------------------------------------------
       Open modal when a motor tile is clicked
       --------------------------------------------- */
    document
        .getElementById('motorsGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.motors-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.motors-modal').forEach(modal => {
