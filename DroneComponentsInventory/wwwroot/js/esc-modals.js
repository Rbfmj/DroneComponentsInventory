(function () {
    ...
    /* ---------------------------------------------
       Open modal when an esc tile is clicked
       --------------------------------------------- */
    document
        .getElementById('escGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.esc-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.esc-modal').forEach(modal => {
