(function () {
    ...
    /* ---------------------------------------------
       Open modal when a battery tile is clicked
       --------------------------------------------- */
    document
        .getElementById('batteryGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.battery-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.battery-modal').forEach(modal => {
