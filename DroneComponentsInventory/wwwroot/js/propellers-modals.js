(function () {
    ...
    /* ---------------------------------------------
       Open modal when a propellers tile is clicked
       --------------------------------------------- */
    document
        .getElementById('propellersGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.propellers-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.propellers-modal').forEach(modal => {
