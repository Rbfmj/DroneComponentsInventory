(function () {
    ...
    /* ---------------------------------------------
       Open modal when a frame tile is clicked
       --------------------------------------------- */
    document
        .getElementById('framesGrid') 
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.frames-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.frames-modal').forEach(modal => {
