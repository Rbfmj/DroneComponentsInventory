(function () {
    ...
    /* ---------------------------------------------
       Open modal when a video transmitters tile is clicked
       --------------------------------------------- */
    document
        .getElementById('videotransmittersGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.videotransmitters-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.videotransmitters-modal').forEach(modal => {
    ...
    document.addEventListener('keydown', event => {
        ...
        const openModal = document.querySelector(
            '.videotransmitters-modal[style*="flex"]'
        );
