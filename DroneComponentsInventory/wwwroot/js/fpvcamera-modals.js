(function () {
    ...
    /* ---------------------------------------------
       Open modal when a fpv camera tile is clicked
       --------------------------------------------- */
    document
        .getElementById('fpvcameraGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.fpvcamera-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.fpvcamera-modal').forEach(modal => {
