(function () {
    ...
    /* ---------------------------------------------
       Open modal when a receiver antennas tile is clicked
       --------------------------------------------- */
    document
        .getElementById('receiverantennasGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.receiverantennas-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.receiverantennas-modal').forEach(modal => {
    ...
    document.addEventListener('keydown', event => {
        ...
        const openModal = document.querySelector(
            '.receiverantennas-modal[style*="flex"]'
        );
