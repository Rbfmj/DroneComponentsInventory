(function () {
    ...
    /* ---------------------------------------------
       Open modal when a radio controller tile is clicked
       --------------------------------------------- */
    document
        .getElementById('radiocontrollersGrid')
    ...
    document.addEventListener('click', event => {
        ...
        const modal = event.target.closest('.radiocontrollers-modal');
    ...
    /* ---------------------------------------------
       ...
       --------------------------------------------- */
    document.querySelectorAll('.radiocontrollers-modal').forEach(modal => {
    ...
    document.addEventListener('keydown', event => {
        ...
        const openModal = document.querySelector(
            '.radiocontrollers-modal[style*="flex"]'
        );
